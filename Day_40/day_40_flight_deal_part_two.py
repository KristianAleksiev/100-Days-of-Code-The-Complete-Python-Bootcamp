### Day 40 - Capstone project - Flight deal finder part two - Flight club
...
for destination_code in destinations:
    ...
    if flight.price < destinations[destination_code]["price"]:
        ...
        link = f"https://www.google.co.uk/flights?hl=en#flt={flight.origin_airport}.{flight.destination_airport}.{flight.out_date}*{flight.destination_airport}." \
